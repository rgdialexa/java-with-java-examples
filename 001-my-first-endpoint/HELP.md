...
* The original package name 'com.dialexa.my-first-endpoint.my-first-endpoint' is invalid and this project uses 'com.dialexa.myfirstendpoint.myfirstendpoint' instead.
